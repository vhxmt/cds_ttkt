// src/app/api/hop-tac/hop-tac-khoi-han-lam/route.ts
import fs from 'fs';
import path from 'path';
import { NextRequest, NextResponse } from 'next/server';

// Path to the JSON file and images folder
const jsonFilePath = path.join(process.cwd(), 'src/data/hop-tac/hop-tac-khoi-han-lam/cooperationEventData.json');
const imageFolderPath = path.join(process.cwd(), 'public/image/hop-tac/hop-tac-khoi-han-lam');
