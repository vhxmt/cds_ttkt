...
const jsonFilePath = path.join(process.cwd(), 'src/data/blogs/dien-tu-vien-thong/data.json');
const imageFolderPath = path.join(process.cwd(), 'public/image/blogs/dien-tu-vien-thong');
