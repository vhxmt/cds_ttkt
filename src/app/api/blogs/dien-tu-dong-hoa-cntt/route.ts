...
const jsonFilePath = path.join(process.cwd(), 'src/data/blogs/dien-tu-dong-hoa-cntt/data.json');
const imageFolderPath = path.join(process.cwd(), 'public/image/blogs/dien-tu-dong-hoa-cntt');
