// src/app/NewPage/giai-thuong/giai-thuong-bai-trinh-bay-hoi-nghi/page.tsx
'use client';
...
export default function BaiBaoKhac() {
    ...
    const fetchAwards = useCallback(async () => {
        setIsLoading(true);
        try {
            const response = await fetch('/api/giai-thuong/giai-thuong-bai-trinh-bay-hoi-nghi', {
                method: 'GET',
            });
            if (!response.ok) {
    ...
    const handleDelete = async (award: Award) => {
        try {
            const response = await fetch(`/api/giai-thuong/giai-thuong-bai-trinh-bay-hoi-nghi?id=${award.id}`, {
                method: 'DELETE',
            });
    ...
    const handleModalSubmit = async (award: Award) => {
        ...
        const url = award.id
            ? `/api/giai-thuong/giai-thuong-bai-trinh-bay-hoi-nghi?id=${award.id}`
            : '/api/giai-thuong/giai-thuong-bai-trinh-bay-hoi-nghi';
        ...
        <div className="max-w-6xl mx-auto p-4">
            ...
            <div className="flex space-x-4">
                ...
                <div className="w-3/4 p-4 border-l border-gray-300">
                    <h3 className="text-xl font-semibold mb-2 text-center">Giải thưởng Bài trình bày Hội nghị</h3>
