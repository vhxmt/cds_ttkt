// src/app/NewPage/giai-thuong/giai-thuong-khac/page.tsx
'use client';
...
export default function BaiBaoKhac() {
    ...
    const fetchAwards = useCallback(async () => {
        setIsLoading(true);
        try {
            const response = await fetch('/api/giai-thuong/giai-thuong-khac', {
                method: 'GET',
            });
            if (!response.ok) {
    ...
    const handleDelete = async (award: Award) => {
        try {
            const response = await fetch(`/api/giai-thuong/giai-thuong-khac?id=${award.id}`, {
                method: 'DELETE',
            });
    ...
    const handleModalSubmit = async (award: Award) => {
        ...
        const url = award.id
            ? `/api/giai-thuong/giai-thuong-khac?id=${award.id}`
            : '/api/giai-thuong/giai-thuong-khac';
