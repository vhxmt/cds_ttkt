// src/app/NewPage/nhan-luc/sinh-vien-thac-si/page.tsx
"use client";
...
export default function NewsPage() {
    ...
    const handleSubmitForm = async (staff: Staff, imageFile?: File) => {
        try {
            ...
            if (imageFile) {
                ...
                const uploadResponse = await fetch('/api/nhan-luc/sinh-vien-thac-si/upload', {
                    method: 'POST',
                    body: formData,
                });
            ...
            const url = editingStaff
                ...
                : '/api/nhan-luc/sinh-vien-thac-si';
    ...
    const handleDelete = async (staff: Staff) => {
        try {
            const response = await fetch(`/api/nhan-luc/sinh-vien-thac-si?id=${staff.id}`, {
                method: 'DELETE',
            });
