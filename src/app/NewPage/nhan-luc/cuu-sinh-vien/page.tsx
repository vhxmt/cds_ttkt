// src/app/NewPage/nhan-luc/cuu-sinh-vien/page.tsx
"use client";
...
export default function NewsPage() {
    ...
    const fetchStaffData = async () => {
        ...
        setHasError(false);
        try {
            const response = await fetch('/api/nhan-luc/cuu-sinh-vien');
            if (response.ok) {
    ...
    const handleSubmitForm = async (staff: Staff, imageFile?: File) => {
        try {
            ...
            if (imageFile) {
                ...
                const uploadResponse = await fetch('/api/nhan-luc/cuu-sinh-vien/upload', {
                    method: 'POST',
                    body: formData,
                });
            ...
            const url = editingStaff
                ? `/api/nhan-luc/cuu-sinh-vien?id=${editingStaff.id}`
                : '/api/nhan-luc/cuu-sinh-vien';
    ...
    const handleDelete = async (staff: Staff) => {
        try {
            const response = await fetch(`/api/nhan-luc/cuu-sinh-vien?id=${staff.id}`, {
                method: 'DELETE',
            });
