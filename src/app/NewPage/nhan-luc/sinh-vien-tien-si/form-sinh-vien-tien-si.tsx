// src/app/NewPage/nhan-luc/sinh-vien-tien-si/form-sinh-vien-tien-si.tsx
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (imageFile) {
                ...
                formData.append('folderPath', 'image/nhan-luc/sinh-vien-tien-si'); // Set the folder path for staff images
