// src/app/NewPage/nhan-luc/ncv-sau-thac-si/page.tsx
"use client";
...
import StaffForm from './form-ncv-sau-thac-si';
...
export default function NewsPage() {
    ...
    const fetchStaffData = async () => {
        ...
        setHasError(false);
        try {
            const response = await fetch('/api/nhan-luc/ncv-sau-thac-si');
            if (response.ok) {
    ...
    const handleSubmitForm = async (staff: Staff, imageFile?: File) => {
        try {
            ...
            if (imageFile) {
                ...
                const uploadResponse = await fetch('/api/nhan-luc/ncv-sau-thac-si/upload', {
                    method: 'POST',
                    body: formData,
                });
            ...
            const url = editingStaff
                ? `/api/nhan-luc/ncv-sau-thac-si?id=${editingStaff.id}`
                : '/api/nhan-luc/ncv-sau-thac-si';
    ...
    const handleDelete = async (staff: Staff) => {
        try {
            const response = await fetch(`/api/nhan-luc/ncv-sau-thac-si?id=${staff.id}`, {
                method: 'DELETE',
            });
