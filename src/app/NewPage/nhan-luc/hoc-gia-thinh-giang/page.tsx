// src/app/NewPage/nhan-luc/hoc-gia-thinh-giang/page.tsx
"use client";
...
import StaffForm from './form-hoc-gia-thinh-giang'; 
...
export default function NewsPage() {
    ...
    const fetchStaffData = async () => {
        try {
            const response = await fetch('/api/nhan-luc/hoc-gia-thinh-giang');
            if (response.ok) {
    ...
    const handleSubmitForm = async (staff: Staff, imageFile?: File) => {
        try {
            ...
            if (imageFile) {
                ...
                const uploadResponse = await fetch('/api/nhan-luc/hoc-gia-thinh-giang/upload', {
                    method: 'POST',
                    body: formData,
                });
            ...
            const url = editingStaff
                ? `/api/nhan-luc/hoc-gia-thinh-giang?id=${editingStaff.id}`
                : '/api/nhan-luc/hoc-gia-thinh-giang';
    ...
    const handleDelete = async (staff: Staff) => {
        try {
            const response = await fetch(`/api/nhan-luc/hoc-gia-thinh-giang?id=${staff.id}`, {
                method: 'DELETE',
            });
