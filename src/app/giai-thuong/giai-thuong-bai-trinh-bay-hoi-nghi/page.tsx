...
import data from '@/data/giai-thuong/giai-thuong-bai-trinh-bay-hoi-nghi/data.json';
        ...
        <div className="max-w-6xl mx-auto p-4">
            ...
            <div className="flex space-x-4">
                ...
                <div className="w-3/4 p-4 border-l border-gray-300">
                    <h3 className="text-xl font-semibold mb-2 text-center">Giải thưởng Bài báo trình bày Hội nghị</h3>
