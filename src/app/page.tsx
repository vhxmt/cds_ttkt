...
import Section from "@/components/display-block/Section";
import { domesticCooperation, internationalCooperation } from "@/data/homeData";
...
export default function Home() {
    return (
        <main className="relative min-h-screen bg-gray-100 dark:bg-white">
            ...
            {/* HỢP TÁC TRONG NƯỚC Section */}
            <Section title={domesticCooperation.title} items={domesticCooperation.items} />

            {/* HỢP TÁC QUỐC TẾ Section */}
            <Section title={internationalCooperation.title} items={internationalCooperation.items} />
        </main>
    );
}
