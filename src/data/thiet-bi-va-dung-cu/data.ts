// src/data/toolData.ts
export const toolsTwoCol = [
    {
        title: "PMSM-IM set",
...
export const toolOneCol = {
    title: "DSP Control Boards",
    imgSrc: "/image/thiet-bi/DSP-Control-Boards.png",
    description: ""
};
