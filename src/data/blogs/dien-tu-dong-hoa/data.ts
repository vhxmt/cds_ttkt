...
export const menuItems: MenuItem[] = [
    { label: 'Điện tử viễn thông', href: '/dien-tu-vien-thong' },
    { label: 'Điện - Tự động hóa', href: '/dien-tu-dong-hoa' },
    { label: 'Điện - Tự động hóa - Công nghệ thông tin', href: '/dien-tu-dong-hoa-cong-nghe-thong-tin' },
];
